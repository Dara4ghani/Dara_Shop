...
namespace Dara_Store.Application.Services.Product.Queries.GetProductDetailForAdmin
{
    ...
    public class GetProductDetailForAdminService : IGetProductDetailForAdminService
    {
        ...
        ResultDto<ProductDetailForAdminDto> IGetProductDetailForAdminService.Execute(long Id)
        {
