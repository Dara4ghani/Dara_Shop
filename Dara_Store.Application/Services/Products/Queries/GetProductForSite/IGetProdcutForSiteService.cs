...
namespace Dara_Store.Application.Services.Product.Queries.GetProductForSite
{
    public interface IGetProdcutForSiteService
    {
        ResultDto<ResultProductForSiteDto> Execute(Ordering ordering,string SearchKey, int Page,int pageSize, long? CatId);
    }

    public class GetProductForSiteService : IGetProdcutForSiteService
    {
        ...
        public ResultDto<ResultProductForSiteDto> Execute(Ordering ordering, string SearchKey,int pageSize, int Page, long? CatId)
        {
            int totalRow = 0;
